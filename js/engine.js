...
var Engine = (function(global) {
    ...
    function main() {
        ...
        // winning scenario
        if (gamePlay==2) {
            ctx.drawImage(Resources.get('images/winner.png'), 50, 150, 400, 200);
            document.getElementById("link-button").style.display = 'block';
        };

        // losing scenario
            if (gamePlay==3) {
            ctx.drawImage(Resources.get('images/game-over.png'), 50, 150, 425, 240);
            document.getElementById("link-button").style.display = 'block';
        };
    }
